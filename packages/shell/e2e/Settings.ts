...
export class Settings {
    ...
    public static get onlySpecs(): string {
        return Settings.getSettings('onlySpecs', '');
    }

    public static get skipSpecs(): string {
        return Settings.getSettings('skipSpecs', '');
    }

    public static get onlyList(): string {
        return Settings.getSettings('onlyList', '');
    }

    public static get testUsername(): string {
        return Settings.getSettings('username', '');
    }

    public static get testPassword(): string {
        return Settings.getSettings('password', '');
    }

    public static get logDepth(): string {
        return Settings.getSettings('logDepth', '');
    }
