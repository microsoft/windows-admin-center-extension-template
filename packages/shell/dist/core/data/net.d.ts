...
export declare class Net {
     ...
     * @return {string} the token string.
     */
    static createEncryptedAuthenticationHeader(jwk: string, userNames: string[], password: string): Observable<string>;
    /**
     ...
     */
    static upgradeEncryptedAuthenticationHeader(jwk: string, token: string): Observable<{
        upgraded: boolean;
        token: string;
    }>;
    /**
