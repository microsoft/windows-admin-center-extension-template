...
export declare class CimStream implements WebsocketStreamHandler {
     ...
     */
    constructor(websocketStream: WebsocketStream, powerShellStream: PowerShellStream, authorizationManager: AuthorizationManager);
    /**
     ...
     */
    private setPowerShellParameters(nodeName, options, cimOutput, keys?, data?);
}
