...
import { RpcDialogData, RpcDialogOverlayData, RpcDialogOverlayResult, RpcDialogResult } from './rpc-dialogs';
 ...
 */
export declare enum RpcMessagePacketType {
    Request = 0,
    Response = 1,
    Error = 2,
}
...
export interface RpcOutboundHandlers {
    ...
    overlayCloseHandler: (data: RpcDialogOverlayData) => Promise<RpcDialogOverlayResult>;
}
/**
...
export interface RpcInboundHandlers {
    ...
    overlayOpenHandler: (data: RpcDialogOverlayData) => Promise<void>;
}
/**
