...
import { RpcAlert, RpcAlertSeverity } from '../../../../core/rpc/rpc-dialogs';
...
export interface ConfirmationDialogOptions extends DialogOptions {
    ...
    alert?: RpcAlert;
    /**
     * Set an RpcAlertSeverity value to show a critical or warning button in the absence of an alert
     */
