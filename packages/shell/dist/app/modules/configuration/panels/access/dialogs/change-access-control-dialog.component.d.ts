...
/**
 * The change access control dialog options.
 */
export interface ChangeAccessControlDialogOptions extends DialogOptions {
    /**
...
/**
 * The change access control dialog result.
 */
export interface ChangeAccessControlDialogResult extends DialogResult {
    /**
...
export declare class ChangeAccessControlDialogComponent extends BaseDialogComponent<ChangeAccessControlDialogOptions, ChangeAccessControlDialogResult> implements OnInit, OnDestroy {
     ...
     * Shows the dialog.
     */
    show(options: ChangeAccessControlDialogOptions): Subject<ChangeAccessControlDialogResult>;
    /**
