...
export declare class AzureComponent extends PanelBaseComponent<GeneralModel> implements OnInit, OnDestroy {
    ...
    identity: string;
    isAadEnabled: boolean;
    private aadSubscription;
    private statusSubscription;
    private signOutSubscription;
    constructor(appContextService: AppContextService, router: Router, activatedRoute: ActivatedRoute, formBuilder: FormBuilder, settingsFormService: SettingsFormService, dialogService: DialogService, shellService: ShellService);
    ngOnInit(): void;
    onSignOut(): void;
    ngOnDestroy(): void;
