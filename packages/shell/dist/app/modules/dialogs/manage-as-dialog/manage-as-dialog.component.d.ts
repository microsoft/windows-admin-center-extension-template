 ...
 */
export declare class ManageAsDialogComponent extends BaseDialogComponent<ManageAsDialogOptions, ManageAsDialogResult> implements OnInit, OnDestroy {
     ...
     */
    constructor(dialogService: DialogService, appContextService: AppContextService, authorizationService: AuthorizationService, shellService: ShellService);
    ngOnInit(): void;
    ngOnDestroy(): void;
    /**
     * Shows the dialog.
